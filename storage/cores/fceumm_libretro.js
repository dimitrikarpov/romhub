...
var DYNAMIC_BASE = 9558528,
  DYNAMICTOP_PTR = 4315488
...
function __fillMouseEventData(eventStruct, e, target) {
  ...
  var rect =
    __specialEventTargets.indexOf(target) < 0
      ? __getBoundingClientRect(target)
      : { left: 0, top: 0 }
...
var ___tm_current = 4315504
var ___tm_timezone = (stringToUTF8("GMT", 4315552, 4), 4315552)
function _tzset() {
...
var asmLibraryArg = {
  Ua: _RWebAudioBufferSize,
  Wa: _RWebAudioFree,
  ab: _RWebAudioInit,
  nf: _RWebAudioRecalibrateTime,
  $a: _RWebAudioSampleRate,
  Xa: _RWebAudioSetNonblockState,
  Ya: _RWebAudioStart,
  Za: _RWebAudioStop,
  _a: _RWebAudioWrite,
  Va: _RWebAudioWriteAvail,
  Ta: _RWebCamFree,
  lb: _RWebCamInit,
  Qa: _RWebCamPoll,
  Sa: _RWebCamStart,
  ...
  ef: _eglCreateWindowSurface,
  Fa: _eglDestroyContext,
  lf: _eglDestroySurface,
  hf: _eglGetConfigs,
  jf: _eglGetCurrentContext,
  ff: _eglGetDisplay,
  Ja: _eglGetError,
  Ia: _eglGetProcAddress,
  Ga: _eglInitialize,
  ba: _eglMakeCurrent,
  Ea: _eglQuerySurface,
  kf: _eglSwapBuffers,
  Ha: _eglTerminate,
  db: _emscripten_exit_pointerlock,
  Ud: _emscripten_force_exit,
  da: _emscripten_get_canvas_element_size,
  Ka: _emscripten_get_fullscreen_status,
  J: _emscripten_get_gamepad_status,
  ae: _emscripten_glActiveTexture,
  $d: _emscripten_glAttachShader,
  qe: _emscripten_glBeginQueryEXT,
  _d: _emscripten_glBindAttribLocation,
  Zd: _emscripten_glBindBuffer,
  Yd: _emscripten_glBindFramebuffer,
  Xd: _emscripten_glBindRenderbuffer,
  Wd: _emscripten_glBindTexture,
  ie: _emscripten_glBindVertexArrayOES,
  Vd: _emscripten_glBlendColor,
  Td: _emscripten_glBlendEquation,
  Sd: _emscripten_glBlendEquationSeparate,
  Rd: _emscripten_glBlendFunc,
  Qd: _emscripten_glBlendFuncSeparate,
  Pd: _emscripten_glBufferData,
  Od: _emscripten_glBufferSubData,
  Nd: _emscripten_glCheckFramebufferStatus,
  Md: _emscripten_glClear,
  Ld: _emscripten_glClearColor,
  Kd: _emscripten_glClearDepthf,
  Jd: _emscripten_glClearStencil,
  Id: _emscripten_glColorMask,
  Hd: _emscripten_glCompileShader,
  Gd: _emscripten_glCompressedTexImage2D,
  Fd: _emscripten_glCompressedTexSubImage2D,
  Ed: _emscripten_glCopyTexImage2D,
  Dd: _emscripten_glCopyTexSubImage2D,
  ...
  se: _emscripten_glDeleteQueriesEXT,
  wd: _emscripten_glDeleteRenderbuffers,
  vd: _emscripten_glDeleteShader,
  ud: _emscripten_glDeleteTextures,
  he: _emscripten_glDeleteVertexArraysOES,
  ...
  de: _emscripten_glDrawArraysInstancedANGLE,
  ee: _emscripten_glDrawBuffersWEBGL,
  md: _emscripten_glDrawElements,
  ce: _emscripten_glDrawElementsInstancedANGLE,
  ld: _emscripten_glEnable,
  kd: _emscripten_glEnableVertexAttribArray,
  pe: _emscripten_glEndQueryEXT,
  ...
  fd: _emscripten_glFrontFace,
  ed: _emscripten_glGenBuffers,
  cd: _emscripten_glGenFramebuffers,
  te: _emscripten_glGenQueriesEXT,
  bd: _emscripten_glGenRenderbuffers,
  ad: _emscripten_glGenTextures,
  ...
  Wc: _emscripten_glGetBooleanv,
  Vc: _emscripten_glGetBufferParameteriv,
  Uc: _emscripten_glGetError,
  Tc: _emscripten_glGetFloatv,
  Sc: _emscripten_glGetFramebufferAttachmentParameteriv,
  Rc: _emscripten_glGetIntegerv,
  Pc: _emscripten_glGetProgramInfoLog,
  Qc: _emscripten_glGetProgramiv,
  ke: _emscripten_glGetQueryObjecti64vEXT,
  me: _emscripten_glGetQueryObjectivEXT,
  je: _emscripten_glGetQueryObjectui64vEXT,
  le: _emscripten_glGetQueryObjectuivEXT,
  ne: _emscripten_glGetQueryivEXT,
  Oc: _emscripten_glGetRenderbufferParameteriv,
  Lc: _emscripten_glGetShaderInfoLog,
  Kc: _emscripten_glGetShaderPrecisionFormat,
  ...
  Dc: _emscripten_glGetUniformLocation,
  Fc: _emscripten_glGetUniformfv,
  Ec: _emscripten_glGetUniformiv,
  zc: _emscripten_glGetVertexAttribPointerv,
  Cc: _emscripten_glGetVertexAttribfv,
  Ac: _emscripten_glGetVertexAttribiv,
  yc: _emscripten_glHint,
  xc: _emscripten_glIsBuffer,
  wc: _emscripten_glIsEnabled,
  vc: _emscripten_glIsFramebuffer,
  uc: _emscripten_glIsProgram,
  re: _emscripten_glIsQueryEXT,
  tc: _emscripten_glIsRenderbuffer,
  sc: _emscripten_glIsShader,
  rc: _emscripten_glIsTexture,
  fe: _emscripten_glIsVertexArrayOES,
  qc: _emscripten_glLineWidth,
  pc: _emscripten_glLinkProgram,
  oc: _emscripten_glPixelStorei,
  nc: _emscripten_glPolygonOffset,
  oe: _emscripten_glQueryCounterEXT,
  mc: _emscripten_glReadPixels,
  lc: _emscripten_glReleaseShaderCompiler,
  kc: _emscripten_glRenderbufferStorage,
  jc: _emscripten_glSampleCoverage,
  ic: _emscripten_glScissor,
  hc: _emscripten_glShaderBinary,
  gc: _emscripten_glShaderSource,
  fc: _emscripten_glStencilFunc,
  ec: _emscripten_glStencilFuncSeparate,
  dc: _emscripten_glStencilMask,
  cc: _emscripten_glStencilMaskSeparate,
  bc: _emscripten_glStencilOp,
  ac: _emscripten_glStencilOpSeparate,
  $b: _emscripten_glTexImage2D,
  _b: _emscripten_glTexParameterf,
  Zb: _emscripten_glTexParameterfv,
  Xb: _emscripten_glTexParameteri,
  Wb: _emscripten_glTexParameteriv,
  Vb: _emscripten_glTexSubImage2D,
  Ub: _emscripten_glUniform1f,
  Tb: _emscripten_glUniform1fv,
  Sb: _emscripten_glUniform1i,
  Rb: _emscripten_glUniform1iv,
  Qb: _emscripten_glUniform2f,
  Pb: _emscripten_glUniform2fv,
  Ob: _emscripten_glUniform2i,
  ...
  Nb: _emscripten_set_keydown_callback_on_thread,
  rb: _emscripten_set_keypress_callback_on_thread,
  Cb: _emscripten_set_keyup_callback_on_thread,
  Yb: _emscripten_set_main_loop,
  ca: _emscripten_set_main_loop_timing,
  jb: _emscripten_set_mousedown_callback_on_thread,
  hb: _emscripten_set_mousemove_callback_on_thread,
  ib: _emscripten_set_mouseup_callback_on_thread,
  gb: _emscripten_set_wheel_callback_on_thread,
  xe: _environ_get,
  ye: _environ_sizes_get,
  ra: _exit,
  M: _fd_close,
  we: _fd_fdstat_get,
  Me: _fd_read,
  ...
  ja: _glGetError,
  T: _glGetIntegerv,
  Xe: _glGetProgramInfoLog,
  ya: _glGetProgramiv,
  Qe: _glGetShaderInfoLog,
  qa: _glGetShaderiv,
  k: _glGetString,
  ...
  bf: _glUniform4f,
  _e: _glUniform4fv,
  We: _glUniformMatrix4fv,
  H: _glUseProgram,
  Te: _glVertexAttribPointer,
  v: _glViewport,
  e: invoke_i,
  o: invoke_ii,
  p: invoke_iii,
